...
- [多态的实现原理](#多态的实现原理)
  - [动态绑定](#动态绑定)
- [多态的实现方式](#多态的实现方式)
  - [编译时多态（Compile-time Polymorphism）](#编译时多态compile-time-polymorphism)
  - [运行时多态（Runtime Polymorphism）](#运行时多态runtime-polymorphism)
  - [方法重载和方法重写的比较](#方法重载和方法重写的比较)
- [向上转型和向下转型](#向上转型和向下转型)
  - [向上转型（儿子变父亲）](#向上转型儿子变父亲)
  - [向下转型（父亲变儿子）](#向下转型父亲变儿子)
    - [语法格式](#语法格式)
    - [示例代码](#示例代码)
    - [instance of关键字](#instance-of关键字)
