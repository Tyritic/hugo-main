...
- [接口的定义](#接口的定义)
- [接口的主要特点](#接口的主要特点)
- [Java为什么允许多实现不允许多继承](#java为什么允许多实现不允许多继承)
  - [为什么不允许多继承](#为什么不允许多继承)
  - [为什么接口可以多实现？](#为什么接口可以多实现？)
- [接口的语法实现](#接口的语法实现)
  - [定义接口](#定义接口)
  - [实现接口](#实现接口)
- [接口中的变量](#接口中的变量)
...
<div align="center">
  <img src="Snipaste_2024-05-07_19-32-55_mianshiya.jpg" alt="菱形继承" width="60%">
</div>
...
<div align="center">
  <img src="1720683675376-c5af6668-4538-479f-84e8-42d4143ab101.webp" alt="内存示意图" width="60%">
</div>
