...
- [内存泄漏和内存溢出](#内存泄漏和内存溢出)
  - [内存泄漏](#内存泄漏)
    - [内存泄漏的原因](#内存泄漏的原因)
    - [ThreadLocal 的内存泄漏问题](#threadlocal-的内存泄漏问题)
  - [内存溢出](#内存溢出)
    - [内存溢出的常见情况](#内存溢出的常见情况)
...
<div align="center">
  <img src="java-runtime-data-areas-jdk1.8.png" alt="Java 运行时数据区域（JDK1.8 ）" width="60%">
</div>
...
<div align="center">
  <img src="stack-area.png" alt="Java 虚拟机栈" width="60%">
</div>
...
<div align="center">
  <img src="1713516384566-e820b967-73ce-49a4-a6e6-36af9a38ebc4.webp" alt="对象创建过程" width="60%">
</div>
...
<div align="center">
  <img src="access-location-of-object-handle.png" alt="对象的访问定位-使用句柄" width="60%">
</div>
...
<div align="center">
  <img src="access-location-of-object-handle-direct-pointer.png" alt="对象的访问定位-直接指针" width="60%">
</div>
