...
- [线程不安全问题](#线程不安全问题)
  ...
  - [指令重排问题](#指令重排问题)
    - [问题定义](#问题定义)
- [Java内存模型的结构](#java内存模型的结构)
- [内存可见性的保证](#内存可见性的保证)
  - [volatile** 关键字](#volatile**-关键字)
  - [synchronized** 关键字](#synchronized**-关键字)
- [顺序一致性的保证和happens-before规则](#顺序一致性的保证和happens-before规则)
  - [指令重排的限制条件](#指令重排的限制条件)
  - [happens-before**规则的定义](#happens-before**规则的定义)
  - [主要规则](#主要规则)
...
<div align="center">
  <img src="jmm-a610752d-ef73-47f2-b02c-6954eb3d62bf.png" alt="两种并发模型的比较" width="60%">
</div>
...
<div align="center">
  <img src="jmm-0b9e4b1e-90e2-41bb-be89-f65e3a10fa08.png" alt="Java运行时数据区域" width="60%">
</div>
...
<div align="center">
  <img src="jmm-f02219aa-e762-4df0-ac08-6f4cceb535c2.jpg" alt="JMM抽象示意图" width="60%">
</div>
