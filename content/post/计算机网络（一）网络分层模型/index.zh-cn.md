...
categories : ["计算机网络"]
tags : ["计算机基础"]
description : "深入理解 OSI 七层模型与 TCP/IP 四层模型，从网络设备、分组交换到数据封装，逐层剖析计算机网络的核心概念"
math : true
---
...
<div align="center">
  <img src="osi七层模型2.png" alt="OSI七层模型示意图" width="85%">
</div>
...
应用层不需要去关心数据是如何传输的，而且应用层是工作在操作系统中的用户态，传输层及以下则工作在内核态。
...
<div align="center">
  <img src="TCP段.png" alt="TCP报文段结构" width="80%">
</div>
...
<div align="center">
  <img src="12.jpg" alt="IP报文分片示意图" width="82%">
</div>
...
<div align="center">
  <img src="16.jpg" alt="网络号计算过程" width="85%">
</div>
...
<div align="center">
  <img src="tcp-ip-4-model.png" alt="TCP/IP四层模型与OSI七层模型对应关系" width="85%">
</div>
...
<div align="center">
  <img src="封装.png" alt="数据封装过程" width="85%">
</div>
...
- 通过 **DNS** 获取到 **IP** 后，就可以把 HTTP 的传输工作交给操作系统中的**协议栈**。
  <div align="center">
    <img src="7.jpg" alt="协议栈示意图" width="82%">
  </div>
...
<div align="center">
  <img src="1720420602148-199136a3-681d-4f87-9bcf-42ef227e6b95.webp" alt="数据包封装过程" width="85%">
</div>
...
<div align="center">
  <img src="640.webp" alt="示例网络拓扑" width="88%">
</div>
