...
- [HashMap提升性能的建议](#hashmap提升性能的建议)
- [HashMap的常用方法](#hashmap的常用方法)
  - [构造方法](#构造方法)
  - [添加键值对](#添加键值对)
  - [删除键值对](#删除键值对)
  - [查询键值对](#查询键值对)
  ...
  - [替换操作](#替换操作)
  - [遍历操作](#遍历操作)
    - [使用for-each循环和entrySet()方法](#使用for-each循环和entryset()方法)
    - [使用for-each循环和keySet()方法](#使用for-each循环和keyset()方法)
    - [使用 Lambda 表达式和forEach()方法](#使用-lambda-表达式和foreach()方法)
- [HashMap的底层原理](#hashmap的底层原理)
  - [存储原理](#存储原理)
    - [JDK 1.7 以前](#jdk-1.7-以前)
    - [JDK 1.8以后](#jdk-1.8以后)
  - [hash方法的底层实现](#hash方法的底层实现)
  - [数组索引计算原理](#数组索引计算原理)
  - [哈希碰撞的解决方法](#哈希碰撞的解决方法)
    - [拉链法（开散列法）](#拉链法开散列法)
    - [开放寻址法（闭散列法）](#开放寻址法闭散列法)
    - [再哈希法（双重哈希）](#再哈希法双重哈希)
  - [扩容机制](#扩容机制)
  - [插入原理（put方法）](#插入原理put方法)
- [equals方法和hashcode方法](#equals方法和hashcode方法)
- [JDK 1.8 的改动](#jdk-1.8-的改动)
- [HashMap的线程安全问题](#hashmap的线程安全问题)
- [自定义HashMap](#自定义hashmap)
  - [内部节点类](#内部节点类)
  - [成员变量](#成员变量)
  - [构造方法](#构造方法)
  - [哈希函数](#哈希函数)
  ...
  - [扩容机制](#扩容机制)
  - [获取键值对的值](#获取键值对的值)
- [HashMap的衍生类——LinkedHashMap类](#hashmap的衍生类——linkedhashmap类)
  - [底层实现](#底层实现)
  - [访问顺序](#访问顺序)
- [HashMap的衍生类——TreeMap类](#hashmap的衍生类——treemap类)
  - [基本特性：](#基本特性：)
  - [与HashMap的区别](#与hashmap的区别)
  - [示例](#示例)
- [HashMap的衍生类——ConcurrentHashMap类](#hashmap的衍生类——concurrenthashmap类)
  - [特点](#特点)
  - [构造方法](#构造方法)
  - [底层实现](#底层实现)
    - [JDK 1.7之前](#jdk-1.7之前)
    - [JDK 1.7以后](#jdk-1.7以后)
  - [加锁机制](#加锁机制)
    - [分段锁加锁机制（JDK 1.7以前）**](#分段锁加锁机制jdk-1.7以前**)
    - [悲观锁和乐观锁（JDK 1.7以后）**](#悲观锁和乐观锁jdk-1.7以后**)
  - [为什么不允许键和值为 null](#为什么不允许键和值为-null)
- [synchronizedMap方法](#synchronizedmap方法)
