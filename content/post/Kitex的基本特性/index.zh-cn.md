...
- Memory: 8GB
- OS: Debian 5.4.56.bsk.1-amd64 x86\_64 GNU/Linux
- Go: 1.15.4
...
| QPS                                      | TP99 | TP999                                      |
| ---------------------------------------- | ---- | ------------------------------------------ |
| ![image](performance_concurrent_qps.png) |      | ![image](performance_concurrent_tp999.png) |

#### 吞吐表现 (并发 100, 改变包大小)

| QPS                                    | TP99 | TP999                                    |
| -------------------------------------- | ---- | ---------------------------------------- |
| ![image](performance_bodysize_qps.png) |      | ![image](performance_bodysize_tp999.png) |
