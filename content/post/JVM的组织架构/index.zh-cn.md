...
- [Java程序的执行流程](#java程序的执行流程)
- [JVM的特性](#jvm的特性)
- [JVM的组织架构](#jvm的组织架构)
  - [类加载器](#类加载器)
  - [运行时数据区](#运行时数据区)
  - [执行引擎](#执行引擎)
  - [本地方法接口（JNI）](#本地方法接口jni)
...
<div align="center">
  <img src="seven-06.png" alt="JVM的组织架构" width="60%">
</div>
...
JVM 定义了 Java 程序运行期间需要使用到的内存区域，简单来说，这块内存区域存放了字节码信息以及程序执行过程的数据，垃圾收集器]也会针对运行时数据区进行对象回收的工作。<div align="center">
  <img src="seven-07.png" alt="运行时数据区" width="60%">
</div>
