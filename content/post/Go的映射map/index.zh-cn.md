...
```text
cannot take the address of m["go"]
```
...
<div align="center">
  <img src="image-20250705152036529.png" alt="bmap结构示意图" width="82%">
</div>
...
<div align="center">
  <img src="image-20250705152403075.png" alt="溢出桶结构示意图" width="82%">
</div>
...
<div align="center">
  <img src="image-8.png" alt="Go map整体结构图示" width="82%">
</div>
...
<div align="center">
  <img src="image.png" alt="tophash与hash值拆分示意图" width="80%">
</div>
...
<div align="center">
  <img src="image-20250629230415231.png" alt="桶个数为2的幂次方示意图" width="82%">
</div>

<div align="center">
  <img src="image-20250629230451483.png" alt="桶个数非2的幂次方示意图" width="82%">
</div>
...
<div align=”center”>
  <img src=”image-6.png” alt=”拉链法示意图” width=”75%”>
</div>
...
<div align="center">
  <img src="image-7.png" alt="开放地址法示意图" width="75%">
</div>
...
<div align="center">
  <img src="image-20250629230701915.png" alt="哈希冲突拉链法示意图" width="82%">
</div>
...
<div align="center">
  <img src="image-20250705103250080.png" alt="渐进式迁移示意图" width="82%">
</div>
...
<div align="center">
  <img src="image-20250705150446177.png" alt="hmap扩容结构示意图" width="82%">
</div>
...
<div align="center">
  <img src="image-2.png" alt="负载因子触发翻倍扩容示意图" width="80%">
</div>
...
<div align="center">
  <img src="image-20250705151205084.png" alt="翻倍扩容示意图" width="82%">
</div>
...
<div align="center">
  <img src="image-20250705151610188.png" alt="再哈希迁移位置示意图" width="82%">
</div>
...
<div align="center">
  <img src="image-3.png" alt="等量扩容触发条件示意图" width="80%">
</div>
...
<div align="center">
  <img src="image-20250705155038432.png" alt="等量扩容示意图" width="82%">
</div>
...
<div align="center">
  <img src="image-1.png" alt="map访问流程示意图" width="80%">
</div>
...
<div align="center">
  <img src="image-4.png" alt="map删除前的状态示意图" width="78%">
</div>

如果这时删除了 `overflow bucket 1` 中的 `key2`、`key4`，以及 `overflow bucket 2` 中的 `key7`，删除后的状态就会变成第二张图：

<div align="center">
  <img src="image-5.png" alt="map删除后的状态示意图" width="78%">
</div>
