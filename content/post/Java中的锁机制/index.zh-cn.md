...
<div align="center">
  <img src="2019-4死锁1.png" alt="线程死锁示意图 " width="60%">
</div>
...
<div align="center">
  <img src="javathread-36.png" alt="锁升级简略过程" width="60%">
</div>
...
- **总线锁定**：通过锁定 CPU 的总线，禁止其他 CPU 或设备访问内存。在进行操作时，CPU 发出一个 LOCK 信号，这会阻止其他处理器对内存地址进行操作，直到当前指令执行完成。<div align="center">
  <img src="javathread-20241115161305.png" alt="总线锁定" width="60%">
</div>
